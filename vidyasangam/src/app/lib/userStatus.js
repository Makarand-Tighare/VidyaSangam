...
export async function checkUserMentorMenteeStatus() {
  try {
    ...
    const profileResponse = await authenticatedFetch('https://project-api-qgho.onrender.com/api/user/profile/');
    ...
    const statusResponse = await authenticatedFetch(`https://project-api-qgho.onrender.com/api/mentor_mentee/profile/${regNo}/`);
...
export async function checkMentoringFormSubmitted() {
  try {
    ...
    const applicationResponse = await authenticatedFetch(`https://project-api-qgho.onrender.com/api/mentor_mentee/profile/${regNo}/`);
