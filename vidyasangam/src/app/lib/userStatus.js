...
export async function checkUserMentorMenteeStatus() {
  try {
    ...
    const profileResponse = await authenticatedFetch('https://df33-54-166-190-24.ngrok-free.app/api/user/profile/');
    ...
    const statusResponse = await authenticatedFetch(`https://df33-54-166-190-24.ngrok-free.app/api/mentor_mentee/profile/${regNo}/`);
...
export async function checkMentoringFormSubmitted() {
  try {
    ...
    const applicationResponse = await authenticatedFetch(`https://df33-54-166-190-24.ngrok-free.app/api/mentor_mentee/profile/${regNo}/`);
