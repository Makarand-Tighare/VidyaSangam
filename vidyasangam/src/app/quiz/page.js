    ...
    const fetchQuiz = async () => {
      try {
        ...
        const endpoint = viewResults 
          ? `https://project-api-qgho.onrender.com/api/mentor_mentee/quiz-results/${menteeId}/` 
          : `https://project-api-qgho.onrender.com/api/mentor_mentee/pending-quizzes/${menteeId}/`;
