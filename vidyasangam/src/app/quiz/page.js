    ...
    const fetchQuiz = async () => {
      try {
        ...
        const endpoint = viewResults 
          ? `https://df33-54-166-190-24.ngrok-free.app/api/mentor_mentee/quiz/results/${menteeId}/` 
          : `https://df33-54-166-190-24.ngrok-free.app/api/mentor_mentee/quiz/pending/${menteeId}/`;
